    ...
    if 'emp_id' in request.form and 'basic' in request.form and 'days' in request.form: 
        ...
        try: 
            ...
            for row in WorkHour:
                ...
                total_seconds = WorkHour.second + WorkHour.minute*60 + WorkHour.hour*60*60 
                Final += total_seconds
                Final - Final/3600 
...
def AddEmp():
    ...
    insert_sql = "INSERT INTO employee(first_name,last_name,education,location) VALUES (%s, %s, %s, %s)"
